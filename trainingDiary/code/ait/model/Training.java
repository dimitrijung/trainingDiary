...
public class Training implements Serializable {
    ...
    // Поле для хранения даты тренировки
    private LocalDate date;

    // Поле для хранения типа тренировки (например, WALKING, RUNNING и т.д.)
    private TrainingType type;

    // Поле для хранения расстояния, пройденного во время тренировки (в километрах)
    private double distance;

    // Поле для хранения времени, затраченного на тренировку (в часах)
